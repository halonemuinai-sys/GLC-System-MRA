          ...
          <div className="w-full sm:w-48">
            <SearchableSelect
              ...
              options={brands
                ...
                .map((b) => ({
                  ...b,
                  company_name: b.m_company?.name || ''
                }))}
              placeholder="Semua Brand"
              allOptionLabel="Semua Brand"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <SearchableSelect
                      ...
                      placeholder="-- Universal / Berlaku untuk Semua Brand --"
                      allOptionLabel="-- Universal / Berlaku untuk Semua Brand --"
                      searchPlaceholder="Ketik untuk mencari Brand..."
                      subtitleKey="company_name"
                    />
                  </div>
